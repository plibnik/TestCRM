...
<table>
    ...
    UPD: схоже, обійшлося без фіксованої, вже юзаю набір фікс. лінків у layouts/app.blade.php, треба прибрати цей "На головну" FIXME TODO
    -->

    <tr>
        <td> <a href="/">На головну</a> </td>     <!--<td><a href = "/companies"> Компанії </a> </td> -->
        <!-- а тут теж компанії, але новий спосіб-->
        <td> <a href="{{{route('companies.index') }}}"> Компанії</a></td>
    </tr>
